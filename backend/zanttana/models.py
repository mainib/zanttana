...
class Zantta(models.Model):
    ...
    members = models.ManyToManyField(Profile, related_name='zantta_members')
...
class Lodging(models.Model):
    ...
    members_booked = models.ManyToManyField(User, related_name='lodge_members_booked')
...
class Logistics(models.Model):
    ...
    members_booked = models.ManyToManyField(User, related_name='logistic_members_booked')
